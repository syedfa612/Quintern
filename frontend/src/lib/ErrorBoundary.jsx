...
export default class ErrorBoundary extends Component {
  ...
  render() {
    ...
    return (
      <div role="alert" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-rose-50 p-6">
        <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl border border-rose-200 p-8 text-center">
          <div className="w-14 h-14 rounded-2xl bg-rose-50 text-rose-600 mx-auto flex items-center justify-center text-2xl mb-4">⚠️</div>
          <h1 className="text-xl font-bold text-gray-900">Something went wrong</h1>
          <p className="text-sm text-gray-600 mt-2">
            The page hit an unexpected error and was paused to protect your session. Your data is safe.
          </p>
